<?php
    ...
    if($_POST) {
        ...
        if($nominal_bayar > $dt_spp['nominal']) {
            echo "<script>alert('Nominal terlalu besar!');location.href='/SPP/Admin/bayar_spp.php?id_spp=".$dt_spp['id_spp']."';</script>";
        } elseif ($nominal_bayar < $dt_spp['nominal']) {
            echo "<script>alert('Apakah anda yakin ingin menyicil SPP?');location.href='/SPP/Admin/histori_pembayaran.php';</script>";
            ...
            echo "<script>alert('Gagal memproses pembayaran.');location.href='/SPP/Admin/bayar_spp.php?id_spp=".$dt_spp['id_spp']."';</script>";
        }
    }
