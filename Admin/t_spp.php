        ...
        <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="row justify-content-center">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                    <div class="pt-4 pb-2">
                        <h5 class="card-title text-center pb-0 fs-4">Create SPP</h5>
                        <p class="text-center small">Enter spp information</p>
                    </div>
                    <form action="pt_spp.php" method="post" class="row g-3 needs-validation" novalidate>
                        <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" name="tahun" class="form-control" id="tahun" value="" required>
                        ...
                        <div class="input-group has-validation">
                            <input type="number" name="nominal" class="form-control" id="nominal" value="" required>
