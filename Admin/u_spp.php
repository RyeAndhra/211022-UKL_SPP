        ...
        <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="row justify-content-center">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                    <div class="pt-4 pb-2">
                        <h5 class="card-title text-center pb-0 fs-4">Update SPP</h5>
                    </div>
                    <form action="pu_spp.php" method="post" class="row g-3 needs-validation" novalidate>
                        <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <?php 
                                ...
                                while($data_angkatan=mysqli_fetch_array($qry_angkatan)) {
                                    if($data_angkatan['angkatan']==$dt_spp['angkatan']) {
                                        $selek="selected";
                        ...
                        <div class="input-group has-validation">
                            <input type="text" name="tahun" class="form-control" id="tahun" value="<?=$dt_spp['tahun']?>" required>
                            <div class="invalid-feedback">Please enter Tahun.</div>
                        </div>
                        </div>
                        ...
                        <div class="input-group has-validation">
                            <input type="number" name="nominal" class="form-control" id="nominal" value="<?=$dt_spp['nominal']?>" required>
                            <div class="invalid-feedback">Please enter Nominal.</div>
                        </div>
                        </div> 
