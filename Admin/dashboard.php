    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><?=$_SESSION['username']?> | <?=$_SESSION['nama_petugas']?></h5>
              <p>Level : <?=$_SESSION['level']?></p>
              <p>Akses Admin : 
                Login & Logout, CRUD Data (Siswa, Petugas, Kelas, SPP), 
                Lihat Kurang Bayar & Transaksi Pembayaran, Lihat Histori Pembayaran & Generate Laporan</p>
            </div>
          </div>
